...
module.exports = (app) => {
  ...
  const webhook = new WebhookClient({
    channel: {
      url: 'http://bots-connectors:8000/connectors/v1/tenants/chatbot-tenant/listeners/webhook/channels/71a0698f-acbe-4132-96eb-680be39c8769',
      secret: 'DeZkycuDkbiWM3mJdNm9Aea5PqhAyPQh'
    }
  });
